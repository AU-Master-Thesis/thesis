...
#grid(
  rows: 2,
  figure(
    std-block(image("../figures/img/introspection-of-collider-state.png")),
  ...
  figure(
    ...
    caption: [Example output of clicking on a robot.]
  ),
  grid(
    rows: 2,
    figure(
      std-block(image("../figures/img/introspection-of-variable-state.png")),
      caption: [Example output of clicking on a variable.]
    ),
    figure(
