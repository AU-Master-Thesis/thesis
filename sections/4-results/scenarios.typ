...
#{
  ...
  table(
    columns: 2,
    stroke: none,
    $C_("radius")$, table.vline(), [The radius of the circle that the robots are spawned in. Omitted in the Junction scenario, as it is not applicable.],
    $s e e d$, [
